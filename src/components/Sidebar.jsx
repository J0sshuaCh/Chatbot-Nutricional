...
export const Sidebar = ({ isOpen, setIsOpen }) => {
    ...
    return (
        <header className={`sticky md:fixed top-0 left-0 md:h-screen z-100 transition-all duration-150 shadow-sm bg-sidebar
    md:${isOpen ? "w-60" : "w-22"}
        `}>
            <div className={`flex justify-between items-center relative bg-sidebar transition-bg duration-150 md:justify-center `}>
            ...
            {isMobil ?
                <nav className={`absolute w-full -z-20 shadow-sm transition-all duration-200 bg-sidebar 
